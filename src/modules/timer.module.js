...
export class TimerModule extends Module {
  ...
  showTimerModal() {
    ...
    timerModal.classList.add('activeTimer')
  ...
  removeTimerModal() {
    const removeTimerClass = document.querySelector('.activeTimer')

    removeTimerClass.remove()
  ...
  clickOnMenu(timer) {
    const menu = document.querySelector('.timer')
